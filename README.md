...
flowchart TB
    subgraph FRONTEND["🖥️ Frontend Layer (Port 3000)"]
        ...
        HOOKS[Custom Hooks]
        WEBSOCKET[WebSocket Client<br/>STOMP + SockJS]
        AXIOS[Axios HTTP Client]
    end

    subgraph BACKEND["⚙️ Backend Layer (Port 8080)"]
    ...
    style FRONTEND fill:#4299e1,stroke:#2b6cb0,color:#fff
    style BACKEND fill:#48bb78,stroke:#276749,color:#fff
    style STORAGE fill:#e53e3e,stroke:#c53030,color:#fff
    style EXTERNAL fill:#ed8936,stroke:#c05621,color:#fff
```
